...
class MonthPost(View):
    def get(self, request, year, month):
        text = ""
        ...  # create the Posts from a year and a month
...
def post_detail(request, year, month, slug):
    ...
    post = {
        ...
        "content": "В процессе написания очередной программы "
                   "задумался над тем, какой способ создания списков в Python работает быстрее..."
    }
...
def author_posts(request, author_id):
    author = get_object_or_404(Author, pk=author_id)          #  pk - primary_key
